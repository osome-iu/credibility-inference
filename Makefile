...
create_conda_env:
	...
	$(CONDA_ACTIVATE); pip install -e ./libs/; pip install igraph node2vec requests tldextract urlextract cleantext pyarrow sparse-dot-topn tweet-preprocessor langdetect umap-learn; $(DEPENDENCIES)
